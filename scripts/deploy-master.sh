...
ssh $USERNAME@$HOST "ln -s $DEPLOY_TO/releases/$TIMESTAMP/2012/ $CURRENT/2012"
ssh $USERNAME@$HOST "ln -s $DEPLOY_TO/releases/$TIMESTAMP/2013/ $CURRENT/2013"
ssh $USERNAME@$HOST "ln -s $DEPLOY_TO/releases/$TIMESTAMP/2014/ $CURRENT/2014"
ssh $USERNAME@$HOST "ln -s $DEPLOY_TO/releases/$TIMESTAMP/2015/ $CURRENT/2015/"
